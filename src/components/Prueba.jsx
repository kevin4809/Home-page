...
const Navbar = () => {
  ...
  const [changeMenu2, setChangeMenu2] = useState(false);

  const clickButton = (menu) => {
    if (menu === "features") {
      setChangeMenu(!changeMenu);
    } else {
      setChangeMenu2(!changeMenu2);
    }
  };
      ...
      <div className="navbar-content">
        ...
        <ul className="menu-links">
          <li className="menu-link">
            <a href="/#" onClick={() => clickButton("features")}>
              Features <IoIosArrowDown />
            </a>
      
              <ul
                className={`${changeMenu ? "iner-menu-active" : ""} dep-menu`}
              >
                <li className="dep-list">
                  <a href="/#">
                    <svg
                      className="icons"
                      width="14"
          ...
          <li className="menu-link">
            <a href="/#" onClick={() => clickButton("company")}>
              Company <IoIosArrowDown />
            </a>
            <ul
              className={`${
                changeMenu2 ? "iner-menu-active-two" : ""
              } dep-menu`}
            >
              <li className="dep-list">
                <a href="/#">History</a>
        ...
        <button className="buttons button-register">Register</button>
